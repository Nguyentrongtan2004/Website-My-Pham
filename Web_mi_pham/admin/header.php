...
<body class="crm_body_bg">
    ...
    <nav class="sidebar">
        <div class="logo d-flex justify-content-between">
            <a class="large_logo" href="index.php"><img src="../assets/img/logo/logo1.png" alt></a>
        ...
        <ul id="sidebar_menu">
            ...
            <li class>
                ...
                <ul>
                    ...
                    <li><a href="index.php?act=addsp">Thêm mới</a></li>
                </ul>
            </li>
            <li class>
                <a class="has-arrow" aria-expanded="false">
                ...
                <ul>
                    <li><a href="index.php?act=dskh">Danh sách</a></li>
                </ul>
            </li>
            <li class>
                <a class="has-arrow" aria-expanded="false">
